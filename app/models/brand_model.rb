class BrandModel < ActiveRecord::Base
  ...
  def brand_names
    unless self.brandx.match(/ACER|ASUS|CLON|COMPAQ|DELL|EPSON|HP|IBM|LENOVO|SAMSUNG|SONY|ISB SOLABASIC|CANON|KONICA|XEROX|PANASONIC|CISCO|VIEWSONIC|APC|TRIPPLITE/)
