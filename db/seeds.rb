...
#------BIRTHERS---------------------------------------------
  ...
  #---------------OFFICEs-----------------------------------
	...
	#---------------BRANDsMODELs------------------------------
		...
		# 	{ description:'COPIADORA', brandx:'HP',	modelx:'LASERJET SERIE 500, M551' },
		# 	{ description:'COPIADORA', brandx:'HP',	modelx:'LASERJET COLOR HP SERIE 500, M551' },
		# 	{ description:'COPIADORA', brandx:'HP',	modelx:'LASERJET COLOR 5100 TN' },
	...
	#---------------SERVICEREQUESTS---------------------------
		...
		# 	{ idFolio:'190516140-SJC/CC2',	kind:'REPARACION',	itDiagnosis:'-UNIDAD ADF HACE RUIDO Y SE ATORA',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DMIPFYE/198/2016',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'190516140-SJC/F7E',	kind:'REPARACION',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'CORREO 19052016',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'190516140-CSL/17C',	kind:'REPARACION',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'CORREO',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'190516140-CSL/DAF',	kind:'REPARACION',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'190516140-CSL/33D',	kind:'MANTENIMIENTO',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'190516140-CSL/6DE',	kind:'MANTENIMIENTO',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'060616158-SJC/D21',	kind:'MANTENIMIENTO',	itDiagnosis:'SACA LAS COPIAS  MANCHADAS DE UN COSTADO',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'EVALUACION SIST.',	RequestDate: DateTime.strptime('06/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'060616158-SJC/42C',	kind:'MANTENIMIENTO',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('06/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'070616159-SJC/5E5',	kind:'MANTENIMIENTO',	itDiagnosis:'- ATORAMIENTO DE HOJA.  SE VISUALIZA PIEZA QUEBRADA',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('07/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'070616159-SJC/400',	kind:'MANTENIMIENTO',	itDiagnosis:'- ATASCO DE HOJA, SE OBSERVA RODILLO DE ACCESO DE HOJA DETERIORADO SE REQUIERE EVALUACION Y DIAGNOSTICO EN GENERAL.',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('07/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'070616159-SJC/4DC',	kind:'DIAGNOSTICO',	itDiagnosis:'- EQUIPO NO ESTA FUNCIONANDO, SE REQUIRE DIAGNOSTICO GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('07/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'290616181-SJC/91D',	kind:'REPARACION',	itDiagnosis:'NO ESTA EN FUNCION SACA LA COPIA CON UNA RAYA NEGRA, ATORA LAS HOJAS POR PIEZA QUEBRADA EN BANDEJA',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('29/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'300616182-SJC/970',	kind:'MANTENIMIENTO',	itDiagnosis:'IMPRESIONES MANCHADAS, REQUIERE MANTENIMIENTO',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('30/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'300616182-SJC/332',	kind:'MANTENIMIENTO',	itDiagnosis:'IMPRESIONES MANCHADAS, REQUIERE MANTENIMIENTO',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('30/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'300616182-SJC/F4C',	kind:'MANTENIMIENTO',	itDiagnosis:'ALARMA DE CAMBIO KIT DE MANTENIMIENTO',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('30/06/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'050716187-SJC/DEC',	kind:'REPARACION',	itDiagnosis:'SACA LA COPIA MANCHADA, ARROJA ALARMA DE CABIO DE TAMBOR',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('05/07/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'060716188-SJC/658',	kind:'REPARACION',	itDiagnosis:'IMPRIME CON RAYAS, ALARMA DE PAPEL ATORADO, REQUIERE DE MANTENIMIENTO EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DMEYRF/CGRAL/14/2016',	RequestDate: DateTime.strptime('06/07/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'220716204-CSL/A4D',	kind:'MANTENIMIENTO',	itDiagnosis:'ATORA LAS HOJAS, HACE RUIDO EN LA PIEZA DEL FUSOR SE REQUIERE MANTENIMMIENTO GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('22/07/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'250716207-SJC/B58',	kind:'MANTENIMIENTO',	itDiagnosis:'SACA LA COPIA MANCHADA, ARROJA ALARMA DE CABIO DE TAMBOR',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SISTEMAS',	RequestDate: DateTime.strptime('25/07/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'260716208-SJC/F1C',	kind:'REPARACION',	itDiagnosis:'NO SACA COPIAS,  MUESTRA ERROR SIN CALOR EN PANTALLA',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SISTEMAS',	RequestDate: DateTime.strptime('26/07/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'280716210-SJC/4FC',	kind:'REPARACION',	itDiagnosis:'NO SE ENCUENTRA EN FUNCIÓN, ATORA LAS HOJAS, REQUIERE REMPLAZO DE RODILLOS Y MANTENIMIENTO EN GENERAL.',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('28/07/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'020816215-SJC/E31',	kind:'REPARACION',	itDiagnosis:'NO FUNCIONA DESPLIEGA EN PANTALLA ERROR: E000014-0001,',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('02/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'040816217-SJC/D92',	kind:'MANTENIMIENTO',	itDiagnosis:'MANTENIMIENTO EN GENERAL.',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'T.I.F. 199/02/08/16',	RequestDate: DateTime.strptime('04/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'090816222-SJC/74D',	kind:'REPARACION',	itDiagnosis:'ALARMA CAMBIO DE TAMBOR, PELICULA DE FIJACIÓN Y ATORAMIENTO DE HOJA.',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('09/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'110816224-SJC/9F7',	kind:'MANTENIMIENTO',	itDiagnosis:'REQUIERE CAMBIO DE TAMBOR MODELO:  DRUM CARTRIDGE (101R00432).',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DAG/090/2016',	RequestDate: DateTime.strptime('11/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'110816224-SJC/53F',	kind:'MANTENIMIENTO',	itDiagnosis:'IMPRIME CON RAYAS, ALARMA DE PAPEL ATASCADO, REQUIERE DE MANTENIMIENTO EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DMEYRF/CGRAL/14/2016',	RequestDate: DateTime.strptime('11/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'180816231-SJC/5E5',	kind:'REPARACION',	itDiagnosis:'RODILLO DE FIJACION DEL ADF CON RUIDO ESTA DAÑADO Y GOMA DE ALIMENTACION DESGASTADA.',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'dmipeye/198/2016',	RequestDate: DateTime.strptime('18/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'180816231-SJC/879',	kind:'REPARACION',	itDiagnosis:'MANTENIMIENTO Y REVISION EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DMAJ/511/2016',	RequestDate: DateTime.strptime('18/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'220816235-CSL/EE3',	kind:'DIAGNOSTICO',	itDiagnosis:'EQUIPO NO ESTA FUNCIONANDO FALLA EN SENSOR.  MANTENIMIENTO EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('22/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'220816235-CSL/9FC',	kind:'REPARACION',	itDiagnosis:'ERROR EN GOMAS DE ALIMENTACIÓN Y SEPARACIÓN DE PAPEL, SENSOR DE PAPEL ANTES DEL REGISTRO. MANTENIMIENTO EN GENERAL.',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('22/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"Cabo San Lucas").id },
		# 	{ idFolio:'230816236-SJC/F1A',	kind:'MANTENIMIENTO',	itDiagnosis:'MANTENIMIENTO EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DMA/1591/2016',	RequestDate: DateTime.strptime('23/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'230816236-SJC/6C9',	kind:'REPARACION',	itDiagnosis:'REPARACION Y MANTENIMIENTO EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'DGFEYT/197/08/2016',	RequestDate: DateTime.strptime('23/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'240816237-SJC/2FF',	kind:'REPARACION',	itDiagnosis:'EQUIPO NO ESTA FUNCIONANDO SE REQUIERE DIAGNOSTICO EN GENERAL, ERROR DISPLAY',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('24/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id },
		# 	{ idFolio:'250816238-SJC/F2E',	kind:'REPARACION',	itDiagnosis:'ANTECEDENTES: CONSTANTE ATASCO DE HOJA, RODILLO DE ACCESO DE HOJA DETERIORADO, RUIDO EN LA UNIDAD ADF.  MANTENIMINETO Y DIAGNOSTICO EN GENERAL',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'SOL. SISTEMAS',	RequestDate: DateTime.strptime('25/08/2016','%d/%m/%Y'),	Delegation_id: Delegation.find_by(name:"San Jose del Cabo").id }
		# ]
	#---------------COPIERS-----------------------------------
		# Copier.create! [
