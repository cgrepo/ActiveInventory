...
#------BIRTHERS---------------------------------------------
	  ...
	  ##---------------WORKERS-----------------------------------
	 	...
	 	##---------------NETWORKS----------------------------------
			Network.create! [
				{linktype:'ADSL-MODEM',  location:'DIF CSL', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'DESARROLLO URBANO CSL', iprange:'10.10.10.0/24', ip:'10.10.10.10', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'PROTECCION CIVIL', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'ALMACEN-CERRO DEL TIMBRE', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'ZOFEMAT-CERRO DEL TIMBRE', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'ECOLOGIA-CERRO DEL TIMBRE', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'JUVENTUD-CERRO DEL TIMBRE', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'SERVICIOS PUBLICOS CSL', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'COMANDANCIA CANGREJOS', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'BIBLIOTECA LOMAS DEL SOL', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'BIBLIOTECA AMELIA WILKES', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'CULTURA CSL-CERRO DEL TIMBRE', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ADSL-MODEM',  location:'COMANDANCIA CANGREJOS CSL', iprange:'192.168.1.0/24', ip:'192.168.1.254', wifirouter:true },
				{linktype:'ENLACE-WIFI', location:'MODULO REGISTRO CIVIL', iprange:'0', ip:'0', wifirouter:false },
				{linktype:'ENLACE-WIFI', location:'MODULO DESARROLLO URBANO', iprange:'0', ip:'0', wifirouter:false }
			]
	 	##---------------COMPUTERS---------------------------------
