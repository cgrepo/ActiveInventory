...
#------BIRTHERS---------------------------------------------
    ...
    ##---------------SERVICEREQUESTS---------------------------
			ServiceRequest.create! [
				...
				{ idFolio:'290816242-SJC/255', kind:'MANTENIMIENTO',itDiagnosis:'IMPRESIÓN CON MANCHA NEGRA A LO LARGO DE LA HOJA, EN ZONA CENTAL Y LATERAL DERECHA. MANTENIMIENTO  EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('29/08/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. DE EGRESOS'), Provider: Provider.find(2), Copier.find_by(ninventary:'031462') },
				{ idFolio:'300816243-SJC/32B', kind:'REPARACION',   itDiagnosis:'RODILLO DE SEPARACIÓN DEL ADF ESTA DAÑADO Y PROVOCA RUIDO COMO MUESTRA DESGASTE EN LA GOMAS DE ALIMENTACION.  MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('30/08/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. INVER. PROGRAMAS FED. Y ESTATALES AREA DOC. COMPROBATORIA'), Provider: Provider.find(2), Copier.find_by(ninventary:'038087') },
				{ idFolio:'090916253-SJC/34F', kind:'MANTENIMIENTO',itDiagnosis:'IMPRIME RAYAS, MANTENIMIENTO EN GENERAL', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('09/09/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. DE TURISMO (MOD. ATE. EXT.)'), Provider: Provider.find(2), Copier.find_by(ninventary:'028626') },
				{ idFolio:'090916253-SJC/809', kind:'MANTENIMIENTO',itDiagnosis:'IMPRIME MANCHADO, MANTENIMIENTO EN GENERAL', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('09/09/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'CABILDO  XII. AYUNT DE LOS CABOS'), Provider: Provider.find(2), Copier.find_by(ninventary:'021165') },
				{ idFolio:'190916263-SJC/FC6', kind:'MANTENIMIENTO',itDiagnosis:'EN EL MES DE JUNIO SE HISO DIAGNOSTICO Y REPARACION SE SOLICITA SERVICIO DE MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'CM/958/2016', RequestDate: DateTime.strptime('19/09/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'CONTRALORIA MUNICIPAL'), Provider: Provider.find(2), Copier.find_by(ninventary:'007758') },
				{ idFolio:'280916272-SJC/424', kind:'REPARACION',   itDiagnosis:'REVISION , MANTENIMIENTO  Y REPARACIÓN.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMAJ/587/2016', RequestDate: DateTime.strptime('28/09/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. ASUNTOS JURIDICOS, LEGIS. Y REGLAMT.'), Provider: Provider.find(2), Copier.find_by(ninventary:'07017') },
				{ idFolio:'101016284-CSL/531', kind:'REPARACION',   itDiagnosis:'ATORA LAS HOJAS, FALTA DE PIEZAS MASTICA LA HOJA EN LA BANDEJA.  MANTENIMIENTO EN GENERAL', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('10/10/2016'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'COOR. SERVICIOS PUBLICOS CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'031328') },
				{ idFolio:'181016292-SJC/2F4', kind:'MANTENIMIENTO',itDiagnosis:'MANTENIMIENTO EN GENERAL, EQUIPO DE CARGA DE TRABAJO PESADA Y MUCHA PRIORIDAD.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMRH/DN/410/2016', RequestDate: DateTime.strptime('18/10/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DEPTO. NOMINAS SJC'), Provider: Provider.find(2), Copier.find_by(ninventary:'007420') },
				{ idFolio:'011116306-SJC/5C2', kind:'MANTENIMIENTO',itDiagnosis:'MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMAJ/725/2016', RequestDate: DateTime.strptime('01/11/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. ASUNTOS JURIDICOS, LEGIS. Y REGLAMT.'), Provider: Provider.find(2), Copier.find_by(ninventary:'007853') },
				...
				{ idFolio:'011116306-CSL/F6C', kind:'MANTENIMIENTO',itDiagnosis:'MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'SISTEMAS', RequestDate: DateTime.strptime('01/11/2016'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'RECAUDACION DE RENTAS CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'004748') },
				{ idFolio:'101116315-SJC/654', kind:'MANTENIMIENTO',itDiagnosis:'SERVICIO DE MANTENIMIENTO EN GENERAL CON URGENCIA POR CARGA DE TRABAJO', ProviderDiagnosis:'', material:'', DocumentRequest:'DMA/2601/2016', RequestDate: DateTime.strptime('10/11/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. DE ADMINISTRACIÓN'), Provider: Provider.find(2), Copier.find_by(ninventary:'031414') },
				{ idFolio:'231116328-SJC/8CF', kind:'REPARACION',   itDiagnosis:'SE SOLICITA REPARACION EL EQUIPO IMPRIME MANCHADO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DGFET/DMT/337', RequestDate: DateTime.strptime('23/11/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. DE TURISMO (MOD. ATE. EXT.)'), Provider: Provider.find(2), Copier.find_by(ninventary:'028626') },
				{ idFolio:'251116330-SJC/609', kind:'REPARACION',   itDiagnosis:'MANTENIMIENTO GENERAL EL EQUIPO NO FUNCIONA', ProviderDiagnosis:'', material:'', DocumentRequest:'DMIPFYE/445/2016', RequestDate: DateTime.strptime('25/11/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. INVER. PROGRAMAS FED. Y ESTATALES AREA DOC. COMPROBATORIA'), Provider: Provider.find(2), Copier.find_by(ninventary:'038087') },
				{ idFolio:'251116330-SJC/795', kind:'REPARACION',   itDiagnosis:'DE CARÁCTER URGENTE,  RODILLO DESTRUIDO EQUIPO NO FUNCIONA', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('25/11/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. DE CONTABILIDAD'), Provider: Provider.find(2), Copier.find_by(ninventary:'030706') },
				{ idFolio:'011216336-SJC/D11', kind:'REPARACION',   itDiagnosis:'CAMBIO DE EMSAMBLE DE BTR. ACTUALIZACION DE S.OPERATIVO, MANTENIMIENTO EN GENERAL', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('29/11/2016'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'OFICIALIA MAYOR MUNICIPAL'), Provider: Provider.find(2), Copier.find_by(ninventary:'029203') },
				{ idFolio:'081216343-CSL/8A6', kind:'MANTENIMIENTO',itDiagnosis:'FALTA UNIDAD DE TAMBOR GPR22, MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('08/12/2016'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'COORD. DE PREPA ABIERTA CSL'), Provider: Provider.find(2), Copier.find_by(nserie:'(21)TJE06603') },
				{ idFolio:'081216343-CSL/408', kind:'MANTENIMIENTO',itDiagnosis:'MANTENIMIENTO PREVENTIVO EN GENERAL, POR PROXIMO PERIODO DE INICIO DE AÑO.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('08/12/2016'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'COOR. OFICIALIA MAYOR CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'999992') },
				{ idFolio:'081216343-CSL/25E', kind:'MANTENIMIENTO',itDiagnosis:'MANTENIMINETO PREVENTIVO PROXIMO A PERIODO RECAUDATORIO DE INICIO DE AÑO.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL.SISTEMAS', RequestDate: DateTime.strptime('08/12/2016'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'COORD. DE INGRESOS CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'999993') },
				{ idFolio:'081216343-CSL/FD1', kind:'REPARACION',   itDiagnosis:'EL EQUIPO NO ESTA EN FUNCION, SE VISITO Y QUEDARON DE COTIZAR LAMPARA LAS COPIAS SACA UNA FRANJA NEGRA.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('08/12/2016'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'ADMINISTRACION DE SEG. PUB. Y TRANS. CSL CANGREJOS'), Provider: Provider.find(2), Copier.find_by(ninventary:'999990') },
				{ idFolio:'10011710-CSL/A59', kind:'REPARACION',    itDiagnosis:'IMPRIME BORROSO', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL_SISTEMAS', RequestDate: DateTime.strptime('10/01/2017'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'RECAUDACION DE RENTAS CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'004748') },
				{ idFolio:'13011713-SJC/77B', kind:'REPARACION',    itDiagnosis:'EQUIPO NO FUNCIONA, ENCIENDE Y MUESTRA ERROR. DIAGNOSTICO Y MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'DGSPM/134/2016', RequestDate: DateTime.strptime('13/01/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. SERVICIOS PUBLICOS'), Provider: Provider.find(2), Copier.find_by(ninventary:'020422') },
				{ idFolio:'16011716-SJC/C70', kind:'REPARACION',    itDiagnosis:'NO FUNCIONA, DIAGNOSTICO Y MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL SISTEMAS', RequestDate: DateTime.strptime('16/01/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. SERVICIOS PUBLICOS'), Provider: Provider.find(2), Copier.find_by(ninventary:'009343') },
				{ idFolio:'16011716-SJC/00C', kind:'REPARACION',    itDiagnosis:'NO FUNCIONA, DIAGNOSTICO Y MANTENIMIENTO EN GENERAL', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL SISTEMAS', RequestDate: DateTime.strptime('16/01/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. SERVICIOS PUBLICOS'), Provider: Provider.find(2), Copier.find_by(ninventary:'031158') },
				{ idFolio:'17011717-CSL/114', kind:'MANTENIMIENTO', itDiagnosis:'REQUIERE TONER TSX3610M', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL SISTEMAS', RequestDate: DateTime.strptime('17/01/2017'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'COORD. DE INFORMATICA Y SISTEMAS DELEGACION CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'999994') },
				{ idFolio:'20011720-SJC/0D7', kind:'REPARACION',    itDiagnosis:'LA UNIDAD ADF NO FUNCIONA SE REALIZA LA COPIA DE FORMA MANUAL Y SALEN ARRUGADAS LAS HOJAS.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL SISTEMAS', RequestDate: DateTime.strptime('20/01/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'OFICIALIA MAYOR MUNICIPAL'), Provider: Provider.find(2), Copier.find_by(ninventary:'029203') },
				{ idFolio:'20011720-SJC/F71', kind:'REPARACION',    itDiagnosis:'SOLICITA MANTENIMINETO, CAMBIO DE TONER NEGRO', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL SISTEMAS', RequestDate: DateTime.strptime('20/01/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'OFICIALIA MAYOR MUNICIPAL'), Provider: Provider.find(2), Copier.find_by(ninventary:'037509') },
				{ idFolio:'23011723-CSL/C50', kind:'REPARACION',    itDiagnosis:'HOJA ATORADA EN LA PARTE DE FUSOR, DIAGNOSTICO Y MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL SISTEMAS', RequestDate: DateTime.strptime('23/01/2017'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'BIBLIOTECA LOMAS DEL SOL CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'013295') },
				{ idFolio:'02021733-SJC/E90', kind:'REPARACION',    itDiagnosis:'MANTENIMIENTO EN GENERAL, CAMBIO DE KIT DE MANTENIMIENTO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMRH/DN/020/2017', RequestDate: DateTime.strptime('01/02/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DEPTO. NOMINAS SJC'), Provider: Provider.find(2), Copier.find_by(ninventary:'007420') },
				{ idFolio:'02021733-SJC/5D9', kind:'REPARACION',    itDiagnosis:'KIT DE MANTENIMIENTO, DIAGNOSTICO Y MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMRH/DN/020/2017', RequestDate: DateTime.strptime('01/02/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DEPTO. NOMINAS SJC'), Provider: Provider.find(2), Printer.find_by(ninventary:'034977') },
				{ idFolio:'02021733-SJC/B5F', kind:'REPARACION',    itDiagnosis:'KIT DE MANTENIMIENTO, DIAGNOSTICO Y MANTENIMIENTO EN GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMRH/DN/020/2017', RequestDate: DateTime.strptime('01/02/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DEPTO. NOMINAS SJC'), Provider: Provider.find(2), Printer.find_by(ninventary:'032085') },
				{ idFolio:'02021733-SJC/3F2', kind:'REPARACION',    itDiagnosis:'KIT DE MANTENIMIENTO, DIAGNOSTICO Y SERVICIO DE MANTENIMENTO EN  GENERAL.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMRH/DN/020/2017', RequestDate: DateTime.strptime('01/02/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DEPTO. NOMINAS SJC'), Provider: Provider.find(2), Printer.find_by(ninventary:'032086') },
				...
				{ idFolio:'09031768-SJC/BF2', kind:'MANTENIMIENTO', itDiagnosis:'DIAGNOSTICO Y MANTENIMIENTO EN GENERAL,  LAS COPIAS SALEN CON DOS MANCHAS.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL.SISTEMAS', RequestDate: DateTime.strptime('09/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. DE ADMINISTRACIÓN'), Provider: Provider.find(2), Copier.find_by(ninventary:'031414') },
				{ idFolio:'10031769-CSL/F58', kind:'MANTENIMIENTO', itDiagnosis:'MUESTRA ALARMA J6, ERROR EN EL CILINDRO, SOLICITUD DE TONER', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('10/03/2017'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'COOR. OFICIALIA MAYOR CSL'), Provider: Provider.find(2), Copier.find_by(ninventary:'999992') },
				{ idFolio:'22031781-SJC/BB2', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO EN GENERAL, NO ESTA EN FUNCION TIENE ALARMA DE REMPLAZO DE UNIDAD DE IMAGEN.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('22/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MUNICIPAL DE TURISMO'), Provider: Provider.find(2), Printer.find_by(ninventary:'039595') },
				{ idFolio:'28031787-SJC/42D', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO PREVENTIVO E INSTALACION DE PIEZA QUE REQUIERA. EQUIPO DE ALTA CARGA DE TRABAJO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMC-XII-243', RequestDate: DateTime.strptime('28/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. CATASTRO'), Provider: Provider.find(2), Printer.find_by(ninventary:'004317') },
				{ idFolio:'28031787-SJC/AA7', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO PREVENTIVO E INSTALACION DE PIEZA QUE REQUIERA, EQUIPO DE ALTA CARGA DE TRABAJO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMC-XII-243', RequestDate: DateTime.strptime('28/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. CATASTRO'), Provider: Provider.find(2), Printer.find_by(ninventary:'014598') },
				{ idFolio:'28031787-SJC/7E3', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO PREVENTIVO E INSTALACION DE PIEZA DE ACCESORIO QUE REQUIERA, EQUIPO DE ALTA CARGA DE TRABAJO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMC-XII-243', RequestDate: DateTime.strptime('28/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. CATASTRO'), Provider: Provider.find(2), Printer.find_by(ninventary:'032681') },
				{ idFolio:'28031787-SJC/FF2', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO PREVENTIVO E INSTALACION DE PIEZA QUE REQUIERA, EQUIPO DE ALTA CARGA DE TRABAJO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMC-XII-243', RequestDate: DateTime.strptime('28/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. CATASTRO'), Provider: Provider.find(2), Printer.find_by(ninventary:'032679') },
				{ idFolio:'28031787-SJC/528', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO PREVENTIVO E INSTALACION DE PIEZA QUE REQUIERA, EQUIPO DE ALTA CARGA DE TRABAJO.', ProviderDiagnosis:'', material:'', DocumentRequest:'DMC-XII-243', RequestDate: DateTime.strptime('28/03/2017'), Delegation: Delegation.find_by(name:'San Jose del Cabo'), Dependency: Dependency.find_by(name:'DIR. MPAL. CATASTRO'), Provider: Provider.find(2), Printer.find_by(ninventary:'999995') },
				{ idFolio:'28031787-CSL/926', kind:'MANTENIMIENTO', itDiagnosis:'MANTENIMIENTO EN GENERAL, IMPRIME MUY BORROSO Y ALARMA CAMBIO DE KIT DE MANTENIMIENTO.  REMPLAZO DE PIEZA REQUERIDA EQUIPO DE ALTA CARGA DE TRABAJO.', ProviderDiagnosis:'', material:'', DocumentRequest:'SOL. SISTEMAS', RequestDate: DateTime.strptime('28/03/2017'), Delegation: Delegation.find_by(name:'Cabo San Lucas'), Dependency: Dependency.find_by(name:'DIR. MPAL. CATASTRO'), Provider: Provider.find(2), Printer.find_by(ninventary:'032677') }	
			]