...
#------BIRTHERS---------------------------------------------
    ...
    ##---------------SERVICEREQUESTS---------------------------
			ServiceRequest.create! [
				{ idFolio:'190516140-SJC/CC2', 
					kind:'REPARACION',   
					itDiagnosis:'-UNIDAD ADF HACE RUIDO Y SE ATORA',
					ProviderDiagnosis:'',material:'',
					DocumentRequest:'DMIPFYE/198/2016',
					RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),
					Delegation: Delegation.find_by(name:"San Jose del Cabo"),
					Dependency: Dependency.find_by(name:'DIR. MPAL. INVER. PROGRAMAS FED. Y ESTATALES' ),
					Provider: Provider.find_by(name:'COPY SERVICIOS BAJA Y /O DINORA GUILLERMINA ARCE MURILLO' ),
					Copier: Copier.find_by(ninventary:'038088'), 
					Priority:'ALTA' },
