...
#------BIRTHERS---------------------------------------------
  ...
  #---------------OFFICEs-----------------------------------
	...
	#---------------SERVICEREQUESTS---------------------------
		...
		# 		{ idFolio:'190516140-CSL/6DE',	kind:'MANTENIMIENTO',	itDiagnosis:'',	ProviderDiagnosis:'',	material:'',	DocumentRequest:'',	RequestDate: DateTime.strptime('19/05/2016','%d/%m/%Y'),	Delegation: Delegation.find_by(name:"Cabo San Lucas"),	Dependency: Dependency.find_by(name:'COOR. CASA DE LA CULTURA CSL' ),	Provider: Provider.find_by(name:'COPY SERVICIOS BAJA Y /O DINORA GUILLERMINA ARCE MURILLO' ),	Copier: Copier.find_by(ninventary:'011410') },
