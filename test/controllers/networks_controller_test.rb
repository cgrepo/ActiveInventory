...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { genus: @network.genus, ip: @network.ip, iprange: @network.iprange, linktype: @network.linktype, location: @network.location }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { genus: @network.genus, ip: @network.ip, iprange: @network.iprange, linktype: @network.linktype, location: @network.location }
    assert_redirected_to network_path(assigns(:network))
  end
