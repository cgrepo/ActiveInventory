...
class DependenciesControllerTest < ActionController::TestCase
  ...
  test "should create dependency" do
    assert_difference('Dependency.count') do
      post :create, dependency: { Delegation_id: @dependency.Delegation_id, address: @dependency.address, name: @dependency.name, responsable: @dependency.responsable, responsable_email: @dependency.responsable_email, telephone: @dependency.telephone }
    end
  ...
  test "should update dependency" do
    patch :update, id: @dependency, dependency: { Delegation_id: @dependency.Delegation_id, address: @dependency.address, name: @dependency.name, responsable: @dependency.responsable, responsable_email: @dependency.responsable_email, telephone: @dependency.telephone }
    assert_redirected_to dependency_path(assigns(:dependency))
  end
