...
(function() {
  $(document).on("turbolinks:load", function() {
    $('#computers').hide();
    return $('#_Dependency_id').on('change', function() {
      return $('#computers').hide();
    });
  });
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('.operasys').on('change', function() {
      var url;
      if ($('.operasys option:selected').val() === 'plus') {
        url = "/osies/new";
        if (url) {
          return window.location.replace(ur);
        }
      }
    });
    $('.brands4pc').on('change', function() {
      if ($('.brands4pc option:selected').val() === '') {
        return $('.models4pc').empty();
      } else {
        if ($('.brands4pc option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('.models4pc').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    });
    $('.models4pc').on('change', function() {
      if ($('.models4pc option:selected').val() === 'plus') {
        return $.ajax({
          ...
          success: function(data) {
            ...
            return $('#brand_model_brandx').attr('disabled', 'true');
          }
        });
      }
    });
    return $(document).on('submit', 'form#commitAddBrandModel4pc', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('#copier_brand').on('change', function() {
      if ($('#copier_brand option:selected').val() === '') {
        return $('#copier_model').empty();
      } else {
        if ($('#copier_brand option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('#copier_model').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    });
    $('#copier_model').on('change', function() {
    ...
    return $(document).on('submit', 'form#modal4copiers', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
...
(function() {
  $(document).on("turbolinks:load", function() {
    return $('input[type=radio][name="[delegation_level]"]').change(function() {
      return $.ajax({
        url: '/dependencies/',
        type: 'GET',
        dataType: 'script',
        data: {
          Delegation: $('input[type=radio][name="[delegation_level]"]:checked').val()
        }
      });
    });
  });
...
(function() {
  $(document).on("turbolinks:load", function() {
    ...
    return $('.delegations_collection').on('change', function() {
      return $.ajax({
...
(function() {
  $(document).on("turbolinks:load", function() {
    ...
    /*$('.wifichk').click ->
    		alert("HITTED!!!")
     */
    $('.wifichk').change(function() {
      if ($('.wifichk').is(':checked')) {
        return $('.ssid').fadeToggle();
      } else {
        return $('.ssid').hide();
      }
    });
    return $('.net-type').change(function() {
      if ($('.net-type option:selected').val() === 'ADSL-MODEM') {
        return $('.assocnumber').fadeToggle();
      } else {
        return $('.assocnumber').hide();
      }
    });
  });
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('#power_brand').on('change', function() {
      if ($('#power_brand option:selected').val() === '') {
        return $('#power_model').empty();
      } else {
        if ($('#power_brand option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('#power_model').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    });
    $('#power_model').on('change', function() {
    ...
    return $(document).on('submit', 'form#modal4powers', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('.chkwifip').change(function() {
      ...
      if (w) {
        ...
        if (n) {
          $('.pnet').show();
          return $('.pnet-con').show();
        } else {
          $('.pnet').hide();
          return $('.pnet-con').hide();
        }
      }
    });
    $('.chknetp').change(function() {
      var n, w;
      w = $('.chkwifip').is(':checked');
      n = $('.chknetp').is(':checked');
      if (n) {
      ...
      if ($('#printer_brand option:selected').val() === '') {
        ...
        if ($('#printer_brand option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('#printer_model').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    });
    $(document).on('submit', 'form#modal4printers', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
    ...
    return $('#printer_model').on('change', function() {
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
      ...
      if ($('#scanner_brand option:selected').val() === '') {
        ...
        if ($('#scanner_brand option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('#scanner_model').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    ...
    return $(document).on('submit', 'form#modal4scanners', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('#screen_brand').on('change', function() {
      if ($('#screen_brand option:selected').val() === '') {
        return $('#screen_model').empty();
      } else {
        if ($('#screen_brand option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('#screen_model').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    });
    $(document).on('submit', 'form#modal4screens', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
    ...
    return $('#screen_model').on('change', function() {
...
(function() {
  $(document).on("turbolinks:load", function() {
    ...
    $('.delegations').on('change', function() {
      return $.ajax({
    ...
    return $('.dependencies').on('change', function() {
      return $.ajax({
...
(function() {
  $(document).on("turbolinks:load", function() {
    ...
    /*$('.printerdiv').hide()
    	$('.copydiv').hide()
     */
    $('.delegations4statistics').on('change', function() {
      return $.ajax({
    ...
    return $('.dependencies4statistics').on('change', function() {
      return $.ajax({
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('.option_type').on('change', function() {
      if ($('.option_type option:selected').val() === 'VOIP') {
        return $('.net').show(function() {});
      } else {
        return $('.net').hide(function() {});
      }
    });
    $('#telephone_brand').on('change', function() {
      if ($('#telephone_brand option:selected').val() === '') {
        return $('#telephone_model').empty();
      } else {
        if ($('#telephone_brand option:selected').val() === 'plus') {
          ...
          return $.ajax({
            ...
            success: function(data) {
              return $('#telephone_model').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
            }
          });
        }
      }
    });
    $('#telephone_model').on('change', function() {
    ...
    return $(document).on('submit', 'form#modal4telephones', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
