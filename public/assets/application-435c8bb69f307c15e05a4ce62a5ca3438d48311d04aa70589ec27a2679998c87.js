...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    return $(document).on('submit', 'form#commitAddBrandModel', function(e) {
      e.preventDefault();
      if (valuesCompleated()) {
        return $.ajax({
          type: 'GET',
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('.brands4copier').on('change', function() {
      if ($('.brands4copier option:selected').val() === 'plus') {
        ...
        return $.ajax({
          ...
          success: function(data) {
            return $('.models4copier').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
          }
        });
      }
    });
    ...
    $('.chkwific').change(function() {
      ...
      if (wi) {
        ...
        if (net) {
          $('.cnet').show();
          return $('.cnet-con').show();
        } else {
          $('.cnet').hide();
          return $('.cnet-con').hide();
        }
      }
    });
    $('.chknetc').change(function() {
      var net, wi;
      wi = $('.chkwific').is(':checked');
      net = $('.chknetc').is(':checked');
      if (net) {
    ...
    $('.brands4ups').on('change', function() {
      if ($('.brands4ups option:selected').val() === 'plus') {
        ...
        return $.ajax({
          ...
          success: function(data) {
            return $('.models4ups').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
          }
        });
      }
    });
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('.brands4printer').on('change', function() {
      if ($('.brands4printer option:selected').val() === 'plus') {
        ...
        return $.ajax({
          ...
          success: function(data) {
            return $('.models4printer').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
          }
        });
      }
    });
    $('.models4printer').on('change', function() {
...
(function() {
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('.brands4screen').on('change', function() {
      if ($('.brands4screen option:selected').val() === 'plus') {
        ...
        return $.ajax({
          ...
          success: function(data) {
            return $('.models4screen').append('<option class="be-soft_purple smfont" value="plus">AGREGAR</option>');
          }
        });
      }
    });
    $('.models4screen').on('change', function() {
